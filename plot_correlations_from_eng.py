...
for INTEREST in "ell,fra,spa,eng,cmn,swa,swe,fin,deu,hin".split(","):
    ...
    accuracy = [all_bleus[INTEREST, l] for l in languages]
    M = max(accuracy)

    utility = [(all_bleus[INTEREST, l] / M) for l in languages]
    bleus = [(all_bleus[INTEREST, l]) for l in languages]

    papers = [
        paper_num[INTEREST, l] + internal_paper_num[l, INTEREST] for l in languages
    ]
    ec_dem1 = [
        (demand1[l, INTEREST] + demand1[INTEREST, l]) / 1000.0 for l in languages
    ]
    ec_dem2 = [
        (demand2[l, INTEREST] + demand2[INTEREST, l]) / 1000.0 for l in languages
    ]
    ...
    if rho3[0] < 0.5:
        ...
        p3 = np.poly1d(np.polyfit(ec_dem2, utility, 2))
    ...
    if rho4[0] < 0.5:
        ...
        p3 = np.poly1d(np.polyfit(papers, utility, 2))
